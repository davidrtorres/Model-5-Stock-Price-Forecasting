...
Regrading Technical Indicators  I used moving averages and the daily price change to assess a stock's volatility and performance.  I used the 10 and 50 day calculations for the algorithms which are pretty basic.  The Daily Price Change is effective in showing how much the price has changed on a daily basis.  Gives you a pretty good idea how volatile the stock is on a daily basis.
